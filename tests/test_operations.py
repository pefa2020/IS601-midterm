...
class TestModulus(BaseOperationTest):
    ...
    valid_test_cases = {
        "positive_numbers": {"a": "17", "b": "5", "expected": "2"},
        "negative_dividend": {"a": "-17", "b": "5", "expected": "-2"},
        "negative_divisor": {"a": "17", "b": "-5", "expected": "2"},
        "both_negative": {"a": "-17", "b": "-5", "expected": "-2"},
...
class TestIntDivide(BaseOperationTest):
    ...
    valid_test_cases = {
        "positive_numbers": {"a": "17", "b": "5", "expected": "3"},
        "negative_dividend": {"a": "-17", "b": "5", "expected": "-4"},
        "negative_divisor": {"a": "17", "b": "-5", "expected": "-4"},
        "both_negative": {"a": "-17", "b": "-5", "expected": "3"},
        "zero_dividend": {"a": "0", "b": "5", "expected": "0"},
...
class TestPercentage(BaseOperationTest):
    ...
    valid_test_cases = {
        "one_of_two": {"a": "1", "b": "2", "expected": "50"},
        "one_of_four": {"a": "1", "b": "4", "expected": "25"},
        "three_of_four": {"a": "3", "b": "4", "expected": "75"},
        "zero_percent": {"a": "0", "b": "10", "expected": "0"},
        "hundred_percent": {"a": "10", "b": "10", "expected": "100"},
...
class TestAbsoluteDifference(BaseOperationTest):
    ...
    valid_test_cases = {
        "positive_difference_positive": {"a": "10", "b": "4", "expected": "6"},
        "positive_difference_negative_first": {"a": "-10", "b": "-4", "expected": "6"},
        "mixed_signs": {"a": "9", "b": "-2", "expected": "11"},
        "zero_first": {"a": "0", "b": "5", "expected": "5"},
        "zero_second": {"a": "5", "b": "0", "expected": "5"},
        "both_zero": {"a": "0", "b": "0", "expected": "0"},
        "equal_numbers": {"a": "7", "b": "7", "expected": "0"},
        "decimals": {"a": "3.5", "b": "1.2", "expected": "2.3"},
    }
