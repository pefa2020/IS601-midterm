...
class Calculation:
    ...
    def calculate(self) -> Decimal:
        ...
        operations = {
            ...
            "IntDivide": lambda x, y: Decimal(int(x) // int(y)) if y != 0 else self._raise_intdiv_zero(),
    ...
    def _raise_modulus_zero():  # pragma: no cover
        ...
        This method is called when a modulus operation by zero is attempted.
        """
    ...
    def _raise_percent_zero():  # pragma: no cover
        ...
        This method is called when a percentage operation with zero denominator is attempted.
        """
